...
(function () {
  ...
  function airCooling() {
    ...
    return `<svg class="dg dgm dgair dg1" viewBox="0 0 980 1780" width="100%" style="display:block">${STYLE}${VARS}
      ...
      ${row('wire4', SEG, 648, 312, '四線：電源／地／轉速回授／PWM', '轉速回授讓主機知道它在不在轉，PWM 讓主機依溫度調速', 400, 428, 300)}
      ...
      ${DG.fold('air3', '③ 軸承四型｜④⑤ 軸流與離心的差別與 P-Q 曲線', '含油、滾珠、液壓、磁浮四種軸承剖面，軸流與離心的取捨與 P-Q 工作點', `
      <!-- ========== ③ 軸承四型（同一根軸） ========== -->
      ...
      ${DG.fold('air6', '⑥ 整條氣流路徑｜⑦ 混合散熱與噪音', '空氣從前面板到後方的完整路徑、液冷之後風扇還要做什麼、噪音從哪裡來', `
      <!-- ========== ⑥ 整條氣流路徑 ========== -->
      ...
      ${DG.fold('air8', '⑧ 結論框｜⑨ 價值鏈流程列', '結論框、五格流程列，以及資料來源與免責', `
      <!-- ========== ⑧ 說明框 ========== -->
