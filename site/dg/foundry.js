...
(function () {
  ...
  const RING = { cx: 330, cy: 940, r: 140, bw: 88, bh: 30, ar: 192 };
  const STEPS = [
  ...
  function areaWho() {
    return `<g>
      ...
      ${T(30, 1984, '化合物半導體代工：3105 穩懋、8086 宏捷科、4991 環宇-KY —— 跟本圖畫的矽邏輯製程不是同一件事。', 'sub')}
  ...
  function foundryProcess() {
    ...
    return `<svg class="dg dgm rs dgfd dg1" viewBox="0 0 ${CW} 2070" width="100%" style="display:block">${D.STYLE}
