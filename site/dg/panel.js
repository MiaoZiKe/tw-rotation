...
(function () {
  ...
  function panelStack() {
    ...
    return `<svg class="dg dgm dgpn" viewBox="0 0 980 1164" width="100%" style="display:block">${STYLE}${PN_STYLE}
      ...
      ${labelRow('panel_mfg', 688, 122, '上偏光板', '貼在上玻璃外側，方向與下偏光板正交', ax(140, 0), ay(140, 0, 85.5), 268)}
      ${labelRow('display_material', 688, 168, '兩片玻璃基板', '★ 台股沒有 TFT 玻璃基板廠，只有外商', ax(148, 0), ay(148, 0, 76), 268)}
      ${labelRow('panel_mfg', 688, 214, '上玻璃：彩色濾光片', '黑色矩陣框住並排的 R／G／B 色阻', ax(142, 0), ay(142, 0, 66.5), 268)}
      ${labelRow('panel_mfg', 688, 260, '液晶層', '盒厚靠間隙物撐住，周邊一圈封框膠封住', ax(142, 0), ay(142, 0, 60.5), 268)}
      ${labelRow('panel_mfg', 688, 306, '下玻璃上的 TFT 陣列', '閘極線與資料線正交成格，一格一顆電晶體', ax(172, 0), ay(172, 0, 55.5), 268)}
      ${labelRow('panel_mfg', 688, 352, '下偏光板', '★ 貼在下玻璃外側，不是夾在液晶旁邊', ax(172, 0), ay(172, 0, 37.5), 268)}
      ${labelRow('panel_mfg', 688, 398, '背光模組（白光的來源）', '反射片→導光板→擴散片→稜鏡片×2', ax(172, 0), ay(172, 0, 18), 268)}
      ${labelRow('panel_mfg', 688, 444, '端子區：驅動 IC ＋ COF 軟板', '晶片由 IC 設計廠做，面板廠負責貼合上去', ax(190, 44), ay(190, 44, 28), 268)}


      ${D.fold('pn3', '③ 一個像素｜④ 液晶兩種排列｜⑤ 換成 OLED 少掉哪幾層', 'R／G／B 次像素放大、液晶靠轉向控制光、LCD 與 OLED 的疊層對照', `
      <!-- ================= 放大區 ③ 一個像素 ================= -->
      ...
      ${D.fold('pn6', '⑥ 面板製程｜族群 9 檔各站在哪一格｜2026 在看什麼', '製程流程列、兩個結論框，以及資料來源與免責', `
      <!-- ================= 製程 ================= -->
