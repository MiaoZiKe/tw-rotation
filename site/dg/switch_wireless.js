...
(function () {
  ...
  function switchBoard() {
    ...
    sub: '板子很厚、一層層壓起來 —— 剖面看 ②', ax: ax(60, 300), ay: ay(60, 300, 4) }, 684, 420, 280, 6)}
      ...
      ${DG.fold('sw2', '② 層數是被訊號逼出來的：訊號—地—訊號—地', '疊構剖面、為什麼是 40 層以上、參考地平面在做什麼', `
      <!-- ================= ② 板子為什麼要這麼多層 ================= -->
      ...
      ${DG.fold('sw3', '③ 800G 可插拔光模組｜價值鏈流程列', '光模組裡有什麼、OSFP 與 QSFP-DD 兩種外型差在哪、五格價值鏈', `
      <!-- ================= ③ 800G 可插拔光模組 ================= -->
    ...
    { seg: 'switch', t: '交換器整機', s: '白牌 ODM 組裝' }], 174)}
      ...
      ${DG.fold('sw4', '④ 可插拔與共同封裝光學（CPO）：差別只有電訊號走多遠', '兩種架構並排、電訊號路徑長度對照，以及資料來源與免責', `
      <!-- ================= ④ 可插拔 vs CPO ================= -->
